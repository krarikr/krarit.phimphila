            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">แก้ไข้ข้อมูลไซต์งาน</span>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="card-header">
                                <h4 class="card-title">แก้ไขข้อมูลไซต์งาน</h4>
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group text-center">
                                            ...
                                            <div class="col-md-12 mt-3">
                                                <input type="submit" name="btn_site_update" class="btn btn-success" value="เพิ่ม">
