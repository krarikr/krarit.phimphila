<?php
    ...
    if (isset($_REQUEST['btn_mat_insert'])) {
        $mat_ser = $_REQUEST['txt_code'];
        $mat_ty = $_REQUEST['txt_role'];
        $mat_nam = $_REQUEST['txt_name'];
        $mat_bra = $_REQUEST['txt_brand'];
        $mat_qt = $_REQUEST['txt_qty'];
        


        if (empty($mat_ser)) {
            $errorMsg = "กรุณาใส่ข้อมูล รหัส วัสดุ/อุปกรณ์";
        }else if (empty($mat_ty)) {
            ...
            try {
                if (!isset($errorMsg)) {
                    $insert_stmt = $db->prepare("INSERT INTO material(type_id, mat_serail, mat_brand, , mat_name, mat_amount ) VALUES (:mtyp, :mserail, :mbrand, :mname, :mqty)");
                    $insert_stmt->bindParam(':mserail', $mat_ser);
                    $insert_stmt->bindParam(':mtyp', $mat_ty);
                    $insert_stmt->bindParam(':mname', $mat_nam);
                    $insert_stmt->bindParam(':mbrand', $mat_bra);
                    $insert_stmt->bindParam(':mqty', $mat_qt);
            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">เพิ่มข้อมูลวัสดุ/อุปกรณ์ใหม่</span>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="card-header">
                                <h4 class="card-title">ระบุข้อมูลวัสดุ/อุปกรณ์</h4>
                                    ...
                                    <div class="col-md-12 mt-4">
                                        <label>รหัสวัสดุ/อุปกรณ์</label>
                                            <input type="text" class="form-control mt-3" name="txt_code"  id="comment"  ></input>
                                            </div>            
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-4">
                                        <label>ชื่อ</label>
                                            <input type="text" class="form-control mt-3" name="txt_name"  id="comment"  ></input>
                                            </div>            
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-4">
                                        <label>แบนรด์</label>
                                            <input type="text" class="form-control mt-3" name="txt_brand"  id="comment"  ></input>
                                            </div>            
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-4">
                                        <label>จำนวน</label>
                                            <input type="text" class="form-control mt-3" name="txt_qty"  id="comment" ></input>
                                            </div>            
                                        </div>
