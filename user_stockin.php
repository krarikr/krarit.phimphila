            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h3>จัดเก็บอุปกรณ์</h3>
                            <span class="ml-1">การจัดเก็บอุปกรณ์เข้าคลัง</span>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="example2" class="display table" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php 
                                             $select_material = $db->prepare("SELECT * FROM  stock_in");
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row["stock_in_code"]; ?></td>
                                                    <td><?php echo $row["stock_in_name_id"]; ?></td>
                                                    <td><?php echo $row["stock_in_site_id"]; ?></td>
                                                    <td></td>
                                                    <td><a href="#" class="btn btn-outline-success">จัดเก็บ</a></td>
