                    ...
                    <div class="card-header">
                                <h4 class="card-title">สั่งซื้อ</h4>
                                    ...
                                    <div class="col-md-12 mt-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="ปี-เดือน-วัน" id="mdate" name="txt_po_date_add">
                                            </div>            
                                        </div>
                                        ...
                                        <label for="type" class="col-sm-3 control-label">เลือกไซต์งาน</label>
                                            <div class="col-sm-12 mt-4">  
                                             ...
                                             $select_material->execute(); ?>
                                                <option selected="selected">- เลือกไซต์งาน -</option>
                                        ...
                                        <label>รูปภาพ</label><br>
                                            <input type="file" class="mt-3" name="txt_po_image_add" ></input>
