            ...
            <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            ...
                            <span class="ml-1">จัดการข้อมูลโฟร์แมนที่ทำงานอยู่ในบริษัท</span>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">ตารางข้อมูลโฟร์แมน</h4>
                                <a href="admin_pro_add.php" class="btn btn-success mb-3" >เพิ่มโฟร์แมน</a>
                            </div>       
                            <div class="card-body">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php  
                                                            if ($row["user_level"] == 'a'){
                                                            ?>
                                                            <span class="badge badge-dark">เลิกจ้าง</span>

                                                            <?php }else{?>

                                                                <span class="badge badge-primary">ทำงาน</span>
