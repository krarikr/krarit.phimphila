                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table id="example2" class="display table" style="width:100%">
                                        ...
                                        <tbody>
                                        <?php 
                                             $select_material = $db->prepare("SELECT * FROM  list");
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <td><?php  
                                                            ...
                                                            <?php }if($row["list_type"] == '2'){?>

                                                                <span class="badge badge-primary">จัดเก็บ</span>

                                                            <?php }if($row["list_type"] == '3'){ ?>
                                                                <span class="badge badge-dark">สั่งซื้อ</span>
                                                            
                                                            <?php } ?></td>

                                                    <td><?php echo $row["list_code"]; ?></td>
                                                    <td><?php echo $row["list_name_id"]; ?></td>
                                                    <td><?php echo $row["list_site_id"]; ?></td>
                                                    <td><?php echo $row["list_detail"]; ?></td>
                                                    <td><?php echo $row["list_detail_img"]; ?></td>  
                                                    <td><a href="#" class="btn btn-outline-success">รอดำเนินการ</a></td>
